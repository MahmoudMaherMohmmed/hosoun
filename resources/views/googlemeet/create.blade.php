...
@section('title', __('adminstaticword.Create') . ' ' . __('adminstaticword.NewGoogleMeeting'))
@section('body')
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box-header with-border">
                    <h3 class="box-title">
                        {{ __('adminstaticword.Create') }} {{ __('adminstaticword.NewGoogleMeeting') }}
                    </h3>
                ...
                <div class="box-body">
                    <form autocomplete="off" action="{{ route('googlemeet.store') }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group display-none" id="sec1_one">
                                <label for="course_id">{{ __('adminstaticword.Courses') }}:<span
                            ...
                            <div class="form-group">
                                <label for="topic">{{ __('adminstaticword.MeetingTopic') }}:<sup
                                        class="redstar">*</sup></label>
                                <input id="topic" type="text" name="topic" placeholder="Ex. My Meeting"
                            ...
                            <div class="form-group" id="sec4_four">
                                <label for="start_time">{{ __('adminstaticword.StartTime') }}:<sup
                                        class="redstar">*</sup></label>
                            ...
                            <div class="form-group" id="sec5_four">
                                <label for="end_time">{{ __('adminstaticword.EndTime') }}:<sup
                                        class="redstar">*</sup></label>
                            ...
                            <div class="form-group" id="sec3_three">
                                <label for="duration">{{ __('adminstaticword.Duration') }}:<sup
                                        class="redstar">*</sup></label>
                                <input id="duration" placeholder="enter in mins eg 60" type="number" min="1"
                            ...
                            <div class="form-group">
                                <label for="agenda">{{ __('adminstaticword.MeetingAgenda') }}:<sup
                                        class="redstar">*</sup></label>
                            ...
                            <div class="form-group">
                                ...
                                <small class="text-muted"><i class="fa fa-question-circle"></i>
                                    {{ __('adminstaticword.TimezoneNote') }}.</small>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-4">
                                <div class="m-1 form-group">
                                    <button
                                        class="btn btn-success btn-md col-xs-12">{{ __('adminstaticword.CreateMeeting') }}</button>
                                </div>
                            </div>
                        </div>
                    </form>
