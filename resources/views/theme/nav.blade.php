                ...
                <div class="sidebar-nav-icon">
                    <ul>
                        ...
                        @if(Auth::User()->role == "user")
                            ...
                            <a href="{{ route('beinstructor.show') }}" title="Become An Instructor"><li><i class="fas fa-chalkboard-teacher"></i>{{ __('frontstaticword.BecomeAnInstructor') }}</li></a>
                        ...
                        <div class="learning-business learning-business-two">
                            @if(Auth::User()->role == "user")
                                @if($setting->instructor_enable == 1)
                                    <a href="{{ route('beinstructor.show') }}" class="btn btn-link" title="Become An Instructor">{{ __('frontstaticword.BecomeAnInstructor') }}</a>
