                ...
                <div class="col-lg-2 col-md-6">
                    ...
                    <div class="footer-logo">
                        @if($settings->logo_type == 'L')
                            ...
                            <a href="{{ url('/') }}" title="logo"><img src="{{ asset('images/logo/'.$settings->footer_logo) }}" alt="logo" class="img-fluid" style="height: 100px;"></a>
                            @endif
                        @else()
                ...
                <div class="col-lg-2 col-md-6">
                    ...
                    <div class="footer-link">
                        <ul>
                            ...
                            <li><a href="https://abegs.store" title="Online Store" target="_blank">{{ __('frontstaticword.OnlineStore') }}</a></li>
                            @if($gsetting->instructor_enable == 1)
                                @if(Auth::check())
                                    @if(Auth::User()->role == "user")
                                    <li><a href="{{ route('beinstructor.show') }}" title="Become An Instructor">{{ __('frontstaticword.BecomeAnInstructor') }}</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="copyright-social">
                        <div class="ibtdi_copyright">
                            <div style="display:inline">
                                <a href="http://www.ibtdi.com/">
                                تصميم الأكاديميه
                                </a>
                                 <span style="color:white">بواسطه<spanp>
                            ...
                            <a href="http://www.ibtdi.com/">
                                <img style="width:80px" src="{{asset('/images/ibtdi.png')}}" alt="">
                            </a>
                        </div>
                    </div>
                </div>
