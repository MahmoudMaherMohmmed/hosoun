        ...
        <div class="row">
            <div class="col-lg-3">
                ...
                <div class="download-btn btm-20">
                    ...
                    <a href="{{route('cirtificate.download',$course)}}" target="_blank"  class="btn btn-secondary">{{ __('frontstaticword.CertificateDownload') }}</a>
                </div>
            ...
            <div class="col-lg-9">
                <div class="cirtificate-border-one text-center">
                    <div class="cirtificate-border-two" style="zoom: 90%">
