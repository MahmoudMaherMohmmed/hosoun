                        ...
                        <div class="view-dtl">
                            ...
                            <div class="text-right">
                                ...
                                @if($subscrib->plans->duration == 'm')
                                    ...
                                    <li class="rate-r"><s><i class="{{ $currency->icon }}"></i>{{ $subscrib->plans->price }} / {{ $subscrib->plans->duration }} Month</s></li>

                                    <li><b><i class="{{ $currency->icon }}"></i>{{ $subscrib->plans->discount_price }}/ {{ $subscrib->plans->duration }} Month</b></li>

                                    @else

                                    <li class="rate-r"><i class="{{ $currency->icon }}"></i>{{ $subscrib->plans->price }} / {{ $subscrib->plans->duration }} Month</li>
                                ...
                                @else
                                    ...
                                    @if($subscrib->plans->discount_price == !NULL)
                                    <li class="rate-r"><s><i class="{{ $currency->icon }}"></i>{{ $subscrib->plans->price }} / {{ $subscrib->plans->duration }} Days</s></li>

                                    <li><b><i class="{{ $currency->icon }}"></i>{{ $subscrib->plans->discount_price }}/ {{ $subscrib->plans->duration }} Days</b></li>

                                    @else

                                    <li class="rate-r"><i class="{{ $currency->icon }}"></i>{{ $subscrib->plans->price }} / {{ $subscrib->plans->duration }} Days</li>
