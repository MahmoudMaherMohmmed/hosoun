	            ...
	            <div class="col-lg-8 col-sm-8">
	            	...
	            	<div class="payment-gateways">
	            		<div id="accordion" class="second-accordion">
							...
							@endif
							@endif
							@if($gsetting->online_payment_enable == '1')
								@auth
									@if( $mainpay > 0)
										<form class="d-block" action="{{route('myfatoorah')}}" method="POST">
											@csrf
											<input type="hidden" name="mainpay" value="{{$mainpay}}">
											<button type="submit" class="btn btn-outline-primary my-2 w-100">
												أو  من خلال الدفع الإكترونى
											</button>
											<br><br>
											<div class="col-md-12 hvr-grow">
												<img  alt="payments method" src="{{asset('img/payments_method.png')}}" class="w-100" style="zoom: 100%">
											</div>
										</form>
									@endif
								@endauth
