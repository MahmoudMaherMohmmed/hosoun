            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-header confiramtion-border">
                        ...
                        <h2 class="btm-40 text-center">طلب غير ناجح برجاء مراجعه الادارة!</h2>

                        <div class="confirmation-block btm-30" style="color: red">

                            <h4 class="confirmation-title text-center" style="color: red">جارى التحويل..</h4>
                        </div>
