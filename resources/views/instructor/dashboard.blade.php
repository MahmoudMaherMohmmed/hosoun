...
@section('title', __('adminstaticword.Dashboard') . ' - ' . __('adminstaticword.Instructor'))
@section('body')
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-green">
                ...
                <a href="{{url('userenroll')}}" class="small-box-footer"> {{ __('adminstaticword.Moreinfo') }}<i
                        class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-yellow">
                ...
                <a href="{{url('instructorquestion')}}" class="small-box-footer"> {{ __('adminstaticword.Moreinfo') }}<i
                        class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-purple">
                ...
                <a href="{{url('instructoranswer')}}" class="small-box-footer"> {{ __('adminstaticword.Moreinfo') }}<i
                        class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-purple">
                ...
                <a href="{{url('featurecourse')}}" class="small-box-footer"> {{ __('adminstaticword.Moreinfo') }}<i
                        class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-orange">
                ...
                <a href="{{url('blog')}}" class="small-box-footer"> {{ __('adminstaticword.Moreinfo') }}<i
                        class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-aqua">
                ...
                <a href="{{route('zoom.index')}}" class="small-box-footer"> {{ __('adminstaticword.Moreinfo') }}<i
                        class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        @endif
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-green">
                ...
                <a href="{{route('bbl.all.meeting')}}" class="small-box-footer"> {{ __('adminstaticword.Moreinfo') }}<i
                        class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        @endif
