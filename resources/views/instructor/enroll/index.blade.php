...
@section('title', __('adminstaticword.User') . ' ' . __('adminstaticword.Orders') . ' - ' . __('adminstaticword.Instructor'))
@section('body')
        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"> {{ __('adminstaticword.User') }} {{ __('adminstaticword.Orders') }}</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
