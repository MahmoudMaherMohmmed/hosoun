...
@section('title', __('adminstaticword.PendingPayout') . ' - ' . __('adminstaticword.Instructor'))
@section('body')
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form method="post" action="{{url('instructoranswer/'.$pay->id)}}" data-parsley-validate class="form-horizontal form-label-left">
                                            {{ csrf_field() }}
                                            {{ method_field('DELETE') }}
