...
@section('title', __('adminstaticword.FeaturedCourses') . ' - ' . __('adminstaticword.Instructor'))
@section('body')
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <a class="btn btn-info btn-md" href="{{route('featurecourse.create')}}">
                        <i class="glyphicon glyphicon-th-l">+</i>{{ __('adminstaticword.Add') }} {{ __('adminstaticword.FeaturedCourses') }}</a>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><i class="fa {{ $feature->currency_icon }}"></i>{{ $feature->total_amount }}
                                    </td>



                                    <td><a class="btn btn-primary btn-sm"
                                            href="{{route('featurecourse.show',$feature->id)}}">{{ __('adminstaticword.View') }}</a>
                                    </td>
