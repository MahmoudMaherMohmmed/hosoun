...
{{--                  @if($quizzes->count() > 1)--}}
                    <button type="button" id="next_button" class="btn btn-accent me-4 {{$quizzes->count() > 1 ?'':'d-none'}}" onclick="formNext()">{{ __('frontstaticword.Next') }}</button>
{{--                  @else--}}
                    <button type="submit" id="submit_button" class="btn btn-accent me-4 {{$quizzes->count() > 1 ?'d-none':''}}">{{ __('frontstaticword.Finish') }}</button>
{{--                  @endif--}}
