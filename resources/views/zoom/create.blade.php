...
@section('title', __('adminstaticword.Createanewmeeting'))
@section('body')
            ...
            <form autocomplete="off" action="{{ route('zoom.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="toggler">
                                ...
                                <label class="main-toggle toggle-lg" for="link_by">
                        ...
                        <div class="form-group display-none" id="sec1_one">
                            <label for="course_id">{{ __('adminstaticword.Courses') }}:<span class="redstar">*</span></label>
                        ...
                        <div class="form-group">
                            <label for="topic">{{ __('adminstaticword.MeetingTopic') }}:<sup class="redstar">*</sup>
                            </label>
                            <input id="topic" type="text" name="topic" placeholder="Ex. My Meeting" class="form-control" required>
                        </div>

                        <div class="form-group">
                            <div class="custom-control custom-checkbox">
                                <input name="recurring" type="checkbox" class="custom-control-input" id="recurring_meeting">
                                <label class="custom-control-label" for="recurring_meeting">Recurring Metting (with no fixed time)
                                </label>
                                <br>
                            </div>
                        </div>
                        ...
                        <div class="form-group" id="sec3_three">
                            ...
                            <input id="duration" placeholder="enter in mins eg 60" type="number" min="1" name="duration" class="form-control">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input id="agenda" type="text" name="agenda" placeholder="Meeting Agenda" class="form-control" required>
                        </div>

                        <div class="form-group">
                            <label for="timezone">{{ __('adminstaticword.Timezone') }}:</label>
                            <select id="timezone" class="form-control js-example-basic-single" name="timezone">
                                <option value="None">{{ __('adminstaticword.TimezoneNone') }}</option>
                    ...
                    <div class="col-xs-12">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <h5 class="panel-title">{{ __('adminstaticword.Meeting') }} {{ __('adminstaticword.Setting') }}
                                    :</h5>
                                <hr>
                                <div class="custom-control custom-checkbox">
                                ...
                                <div class="custom-control custom-checkbox">
                                    <input name="participant_video" type="checkbox" class="custom-control-input"
                                        id="participant_video">
                                    <label class="custom-control-label" for="participant_video">Enable Participant Video</label>
                                </div>
        
                                <div class="custom-control custom-checkbox">
                                    <input name="join_before_host" type="checkbox" class="custom-control-input"
                                        id="join_before_host">
                                    <label class="custom-control-label" for="join_before_host">Join before host?</label>
                                </div>
        
                                <div class="custom-control custom-checkbox">
                                    <input name="mute_upon_entry" type="checkbox" class="custom-control-input"
                                        id="mute_upon_entry">
                                    <label class="custom-control-label" for="mute_upon_entry">Mute Upon Entry?</label>
                                </div>
        
                                <div class="custom-control custom-checkbox">
                                    <input name="registrants_email_notification" type="checkbox" class="custom-control-input"
                ...
                <div class="row">
                    ...
                    <div class="m-1 form-group col-xs-6 col-sm-3 col-md-2">
                        <button class="btn btn-success btn-md col-xs-12">{{ __('adminstaticword.CreateMeeting') }}</button>
                    </div>
                </div>
