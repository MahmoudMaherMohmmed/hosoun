            ...
            <div class="signup-block">
                ...
                <form method="POST" class="signup-form" action="{{ route('login') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="{{ __('frontstaticword.EnterYourEMail') }}"   name="email" value="{{ old('email') }}" required autofocus>
                    ...
                    <div class="form-group">
                        ...
                        <input id="password" type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" placeholder="{{ __('frontstaticword.EnterYourPassword') }}" name="password" required>
