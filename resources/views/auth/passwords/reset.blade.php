          ...
          <form method="POST" action="{{ route('password.update') }}">
            ...
            <div class="form-group">
              ...
              <div class="form-group-icon">
                <input type="email" name="email" id="email" class="form-control {{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="{{ __('frontstaticword.E-MailAddress') }}" value="{{ old('email') }}" required>
            ...
            <div class="form-group">
              ...
              <div class="form-group-icon">
                <input type="password" name="password" id="password" class="form-control {{ $errors->has('password') ? ' is-invalid' : '' }}" placeholder="{{ __('frontstaticword.Password') }}" required>
                <svg class="svg-default form-control-icon">
            ...
            <div class="form-group">
              ...
              <div class="form-group-icon">
                <input type="password" name="password_confirmation" id="confirm_password" class="form-control" placeholder="{{ __('frontstaticword.ConfirmPassword') }}">
                <svg class="svg-default form-control-icon">
                  <use xlink:href="{{ asset('/front/svg/sprite.svg#lock') }}" />
                </svg>
              </div>
