...
<section id="student" class="student-main-block top-40">
    <div class="container">
        ...
        @if($total_count >= '0' &&  optional($recent_course)->status == 1 && optional($recent_course)->featured == 1)
...
@endphp
@if( ! $cors->isEmpty() ) 
<section id="student" class="student-main-block mt-5">
    <div class="container">
...
<section id="student" class="student-main-block">
    <div class="container">
        ...
        <h4 class="student-heading">{{__('frontstaticword.jitsi')}}</h4>
