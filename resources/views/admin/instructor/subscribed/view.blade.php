...
@section('title', __('adminstaticword.View') . ' ' . __('adminstaticword.Subscription') . ' - ' . __('adminstaticword.Admin'))
@section('body')
      ...
      <div class="col-xs-12">
        <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">{{ __('adminstaticword.View') }} {{ __('adminstaticword.Subscription') }}</h3>
            </div>
