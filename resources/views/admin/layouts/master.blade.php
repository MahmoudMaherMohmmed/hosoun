...
<html class="no-js" 
      lang="{{(in_array($language,$rtl))? 'ar' : 'en' }}" 
      dir="{{(in_array($language,$rtl))? 'rtl' : 'ltr' }}"> 
...
<head>
  ...
  ?>
    ...
    <link rel="stylesheet" href="{{ url('admin/css/intlTelInput.min.css') }}">

    <!-- Custom Css -->
    <link rel="stylesheet" href="{{ url('admin/css/general.css') }}">
    @if (in_array($language,$rtl))
...
<body class="hold-transition skin-blue sidebar-mini fixed">
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="{{ url('/') }}" class="logo">
                ...
                <span class="logo-lg"> <img title="{{ $project_title }}" width="100px"
                        src="{{ url('images/logo/'.$gsetting->logo) }}" alt="" /></span>
            </a>
                ...
                <div class="navbar-custom-menu">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown admin-nav language">
                            <button class="btn btn-primary dropdown-toggle flex-row-center-all" type="button"
                                data-toggle="dropdown">
                                <!--<i class="fa fa-globe"></i> -->
                                <i class='bx bx-globe me'></i>
                        ...
                        <li><a href="{{ url('/') }}" target="_blank" class="visit-site flex-row-center-all">
                                {{ __('adminstaticword.VisitSite') }}
                                <i class='bx bx-link-external ms'></i>
                            </a></li>
    ...
    <script src="{{ url('admin/js/intlTelInput-jquery.min.js')}}"></script>
...
?>
    ...
    <script type="text/javascript">
        tinymce.init({
            ...
            images_upload_url: "{{url('js/postAcceptor.php')}}",
    ...
    <script>
        ...
        $('input[name="mobile"]').on("countrychange", function() {
            $('#mobile_code').val( $('input[name="mobile"]').intlTelInput('getSelectedCountryData').dialCode );
        });
