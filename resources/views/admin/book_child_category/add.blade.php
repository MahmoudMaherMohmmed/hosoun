...
@section('title', __('adminstaticword.AddBookChildCategory'))
        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">{{ __('adminstaticword.AddBookChildCategory') }}</h3>
                ...
                <div class="panel-body">
                    ...
                    <form id="demo-form" method="post" action="{{ route('book-child-categories.store') }}" data-parsley-validate class="form-label-left" autocomplete="off"
