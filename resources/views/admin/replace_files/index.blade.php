...
@section('title', __('adminstaticword.QuickUpdate') . ' - ' . __('adminstaticword.Admin'))
@section('body')
        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">{{ __('adminstaticword.QuickUpdate') }}</h3>
                </div>
                ...
                <div class="panel-body">
                    <div class="callout callout-success">
                        ...
                        <ul>
                            <li>⦿ {{__("Quick update is for bug fix update of version " . env('APP_VERSION'))}}</li>
                            <li>⦿ {{__("Click to quick update when update is available.")}}</li>
                        </ul>
                    </div>
