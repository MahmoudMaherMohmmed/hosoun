        ...
        <div class="col-xs-12">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <a href="{{url('book-sub-categories')}}" class="btn btn-success pull-right owtbtn">
                ...
                <div class="panel-body">
                    ...
                    <form id="demo-form" method="post" action="{{url('book-sub-categories/'.$bookSubCategory->id)}}" data-parsley-validate class="form-label-left" autocomplete="off"
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="book_category_id" id="book_category_id"  class="form-control js-example-basic-single">
                                        @foreach($bookCategories as $bookCategory)
                                            <option value="{{$bookCategory->id}}" {{ $bookSubCategory->book_category_id == $bookCategory->id ? 'selected' : '' }}>{{$bookCategory->title}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="toggler">
                                        <input hidden id="status" type="checkbox" name="status" {{ $bookSubCategory->status == '1' ? 'checked' : '' }}>
                                        <label class="main-toggle toggle-lg {{ $bookSubCategory->status == '1' ? 'on' : '' }}" for="status">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="title" id="title"  value="{{$bookSubCategory->title}}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-xs-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="description" name="description" rows="3" class="form-control"
                                        ...
                                        required>{{$bookSubCategory->description}}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-md-4">
                                ...
                                <div>
                                    ...
                                    @if(isset($bookSubCategory->image))
                                    <img src="{{ url('/images/book_sub_categories/'.$bookSubCategory->image) }}" class="img-responsive" />
                                    @endif
                                </div>
                            </div>
