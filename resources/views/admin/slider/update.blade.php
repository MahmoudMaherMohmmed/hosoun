...
@section('title', __('adminstaticword.Edit') . ' ' . __('adminstaticword.Slider') . ' - ' . __('adminstaticword.Admin'))
@section('body')
              ...
              " data-parsley-validate enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="heading" id="heading" value="{{$cate->heading}}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-md-6 display-none">
                                    <div class="form-group">
                                        <label for="search_text">{{ __('adminstaticword.SearchText') }}:<sup class="redstar">*</sup></label>
                                        <input type="text" class="form-control" name="search_text" id="search_text" value="0">
                                    </div>
                                </div>
                                <div class="col-xs-12">
                                    <div class="form-group">
                                        <label for="details">{{ __('adminstaticword.Detail') }}:<sup class="redstar">*</sup></label>
                                        <textarea id="details" name="detail" rows="5" class="form-control" placeholder="{{ __('adminstaticword.Enter') }} {{ __('adminstaticword.Detail') }}">{{$cate->detail}}</textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-xs-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="button_text" class="form-control" type="text" name="button_text" placeholder="{{ __('adminstaticword.Enter') }} {{ __('adminstaticword.ButtonText') }}" value="{{$cate->button_text}}">
                                    </div>
                                </div>
                                <div class="col-xs-6 col-md-6">
                                    <div class="form-group">
                                        <label for="button_url">{{ __('adminstaticword.ButtonLink') }}:<sup class="redstar">*</sup></label>
                                        <input id="button_url" class="form-control" type="url" name="button_url" placeholder="{{ __('adminstaticword.Enter') }} {{ __('adminstaticword.ButtonLink') }}" value="{{$cate->button_url}}">
                                    </div>
                                </div>
                            </div>
                                ...
                                {{--<div class="col-xs-12 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <small class="text-muted">
                                            <i class="fa fa-question-circle"></i> {{ __('adminstaticword.Recommendedsize') }} (1375 x 409px)
                                        </small>
                                        <div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="toggler">
                                            <input class="tgl tgl-skewed" id="left" type="checkbox" name="left"
                                                {{ $cate->left == '1' ? 'checked' : '' }}>
                                            <label class="main-toggle toggle-lg {{ $cate->left == '1' ? 'on' : '' }}" for="left">
