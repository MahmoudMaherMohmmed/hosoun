...
@section('title', __('adminstaticword.Add') . ' ' . __('adminstaticword.ManualPaymentGateway') . ' - ' . __('adminstaticword.Admin'))
@section('body')
	...
	<div class="row">
		<div class="col-xs-12">
			<div class="box box-primary">
				...
				<div class="box-body">
					<form id="demo-form2" method="post" action="{{url('manualpayment/')}}" data-parsley-validate enctype="multipart/form-data">
						{{ csrf_field() }}
