...
@section('title', __('adminstaticword.RemovePublic') . ' - ' . __('adminstaticword.Admin'))
@section('body')
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box box-primary">
                ...
                <h3 class="box-title">{{ __('adminstaticword.RemovePublic') }}</h3>
                </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary btn-block">
                                    {{ __('adminstaticword.RemovePublic') }}
                                </button>
                            </div>
                        </form>
                        </div>
                ...
                @elseif(!file_exists(base_path().'/'.'.htaccess') )
                     ...
                     <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <h3 class="box-title">{{ __('adminstaticword.RemovePublic') }} {{ __('adminstaticword.From') }} {{ __('adminstaticword.URL') }}</h3>
