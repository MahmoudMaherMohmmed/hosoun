...
@section('title', __('adminstaticword.Dashboard') . ' - ' . __('adminstaticword.Admin'))
@section('body')
...
<section class="content">
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-green">
                ...
                <a href="{{url('category')}}" class="small-box-footer">{{ __('adminstaticword.Moreinfo') }} <i
                        class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-yellow">
                ...
                <a href="{{url('course')}}" class="small-box-footer">{{ __('adminstaticword.Moreinfo') }} <i
                        class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-red">
                ...
                <a href="{{url('order')}}" class="small-box-footer">{{ __('adminstaticword.Moreinfo') }} <i
                        class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-purple">
                ...
                <a href="{{url('faq')}}" class="small-box-footer">{{ __('adminstaticword.Moreinfo') }} <i
                        class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-green">
                ...
                <a href="{{route('all.instructor')}}" class="small-box-footer">{{ __('adminstaticword.Moreinfo') }} <i
                        class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-blue">
                ...
                <a href="{{url('testimonial')}}" class="small-box-footer">{{ __('adminstaticword.Moreinfo') }} <i
                        class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div>
        <!-- ./col -->
    ...
    <div class="row">
                ...
                <div class="box-body no-padding">
                    ...
                    <ul class="users-list clearfix">
                        ...
                        <li>
                            ...
                            <img src="{{ asset('/images/user_img/'.$user['user_img']) }}" class="img-fluid"
                                alt="User Image">
                            @else
        ...
        <div class="col-xs-12 col-md-6 col-lg-8">
            <!-- TABLE: LATEST ORDERS -->
            @php
            $orders = App\Order::with('user', 'courses', 'bundle')->limit(7)->orderBy('id', 'DESC')->get();
            @endphp
            @if( !$orders->isEmpty() )
            <div class="box box-info">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="label label-success"><i
                                                class="fa {{ $order['currency_icon'] }}"></i>
                                            {{ $order['total_amount'] - $order['coupon_discount'] }}</span>
                                        @else
                                        <span
                                            class="label label-success">{{ $order['total_amount'] - $order['coupon_discount'] }}<i
                                                class="fa {{ $order['currency_icon'] }}"></i> </span>
                                        @endif
                                        @else
                                        @if($gsetting['currency_swipe'] == 1)
                                        <span class="label label-success"><i
                                                class="fa {{ $order['currency_icon'] }}"></i> </span>
                                        @else
                                        <span class="label label-success">{{ $order['total_amount'] }}<i
                                                class="fa {{ $order['currency_icon'] }}"></i> </span>
                                        @endif
                                        @endif
                                    </td>
                                    <td>
                                        <div class="sparkbar" data-color="#00a65a" data-height="20">
                                            {{ date('jS F Y', strtotime($order['created_at'])) }}</div>
                                    </td>
                                    <td><a
                                            href="{{route('view.order',$order['id'])}}">{{ __('adminstaticword.Invoice') }}</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
                ...
                <div class="box-footer clearfix">
                    <a href="{{url('order')}}"
                        class="btn btn-sm btn-default btn-flat pull-right">{{ __('adminstaticword.ViewAllOrders') }}</a>
                </div>
                <!-- /.box-footer -->
            </div>
            @endif
            ...
            <div class="box box-success">
                ...
                <div class="box-body chat" id="chat-box">
                    ...
                    <div class="item">
                        <img src="{{ asset('images/instructor/'.$instructor['image'])}}" alt="user image"
                            class="online">

                        <p class="message">
                            <a href="#" class="name">
                                <small class="text-muted pull-right"><i
                                        class="fa fa-calendar-check-o"></i>&nbsp;{{ date('jS F Y', strtotime($instructor['created_at'])) }}</small>
                        ...
                        <div class="attachment">
                            ...
                            <p class="filename">
                                <a href="{{ asset('files/instructor/'.$instructor['file']) }}"
                                    download="{{$instructor['file']}}">{{ __('adminstaticword.Download') }} <i
                                        class="fa fa-download"></i></a>
                            </p>

                            <div class="pull-right">
                                <button type="button"
                                    onclick="window.location.href = '{{route('requestinstructor.edit',$instructor['id'])}}';"
                                    class="btn btn-primary btn-sm btn-flat">{{ __('adminstaticword.ViewDetails') }}</button>
                            </div>
                        </div>
                        <!-- /.attachment -->
                    </div>
                ...
                <div class="box-footer text-center">
                    <a href="{{route('all.instructor')}}"
                        class="btn btn-sm bg-navy btn-flat pull-left">{{ __('adminstaticword.AllInstructor') }}</a>
                    <a href="{{url('requestinstructor')}}"
                        class="btn btn-sm btn-default btn-flat pull-right">{{ __('adminstaticword.ViewAllInstructor') }}</a>
                </div>
            </div>
            @endif
            <!-- /.box (Instructor box) -->
