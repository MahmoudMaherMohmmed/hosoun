...
@section('title', __('adminstaticword.EditCourseChapter'))
@section('body')
    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            ...
            <div class="box box-primary">
                ...
                <!-- form start -->
                <div class="box-body">
                    <form id="demo-form" method="post" action="{{url('coursechapter/'.$cate->id)}}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12">
                                <div class="form-group">
                                    <label for="chapter_name">{{ __('adminstaticword.ChapterName') }}:<span
                                            class="redstar">*</span></label>
                                    <input type="text" class="form-control" name="chapter_name" id="chapter_name"
                                        value="{{$cate->chapter_name}}">
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div>
                                        <input type="file" name="file" value="{{ $cate->file }}" id="file"
