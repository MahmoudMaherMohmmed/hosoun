...
@section('title', __('adminstaticword.Assignment') . ' - ' . __('adminstaticword.Admin'))
@section('body')
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-success btn-sm"
                                            href="{{url('assignment/'.$assign->id)}}">{{ __('adminstaticword.View') }}</a>
                                    </td>

                                    <td>
                                        <form method="post" action="{{url('assignment/'.$assign->id)}}"
