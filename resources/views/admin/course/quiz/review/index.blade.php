...
@section('title', __('adminstaticword.Quiz') . ' ' . __('adminstaticword.Answer') . ' ' . __('adminstaticword.Review'))
@section('body')
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <form action="{{ route('quizreview.quick',$answer->id) }}" method="POST">
                            {{ csrf_field() }}
                            <button  type="Submit" class="btn btn-xs table-status {{ $answer->txt_approved ==1 ? 'btn-success' : 'btn-danger' }}">
