        ...
        <div class="col-xs-12">
            ...
            <div class="box box-primary">
                ...
                <div class="panel-body">
                    ...
                    <form id="demo-form" method="post" action="{{url('category/'.$cate->id)}}" data-parsley-validate class="form-label-left" autocomplete="off"
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="toggler">
                                        <input hidden id="featured" type="checkbox" name="featured" {{ $cate->featured == '1' ? 'checked' : '' }}>
