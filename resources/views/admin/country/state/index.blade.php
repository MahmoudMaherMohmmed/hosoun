...
@section('title', __('adminstaticword.State') . ' - ' . __('adminstaticword.Admin'))
@section("body")
          ...
          <div class="modal-body">
            <form id="demo-form2" method="post" action="{{route('state.manual')}}" data-parsley-validate class="form-horizontal form-label-left">
              {{ csrf_field() }}
				...
				<div class="row">
	              <div class="col-xs-12">
	              	<label for="country_id">{{ __('adminstaticword.ChooseState') }} :<sup class="redstar">*</sup></label>
	                <select id="country_id" style="width: 100%" required class="form-control js-example-basic-single" name="country_id">
				...
				<div class="row">
              	  <div class="col-xs-12">
	                <label for="state"> {{ __('adminstaticword.State') }}:<sup class="redstar">*</sup></label>
