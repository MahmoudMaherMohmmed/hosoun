...
@section('title', __('adminstaticword.Add') . ' ' . __('adminstaticword.City') . ' - ' . __('adminstaticword.Admin'))
@section("body")
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <div class="panel-heading">
                        <a href=" {{url('admin/city')}} " class="btn btn-success pull-right owtbtn">
                            {{ __('adminstaticword.Back') }}
                        </a>
                    </div>
                </div>
                <form id="demo-form2" class="inline-form clear-both" method="post" enctype="multipart/form-data"
                    action="{{url('admin/city')}}" data-parsley-validate class="form-horizontal form-label-left">
                    {{csrf_field()}}
                    <div class="box-body">
                        <div class="form-group row">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="state_id">
                                {{ __('adminstaticword.Add') }} {{ __('adminstaticword.City') }}<span
                                class="redstar">*</span>
                            </label>
