...
@section('title', __('adminstaticword.Edit') . ' ' . __('adminstaticword.ReportCourse') . ' - ' . __('adminstaticword.Admin'))
@section('body')
        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <a href="{{url('user/course/report')}}" class="btn btn-success pull-right owtbtn">
