            ...
            <div class="panel-body">
                ...
                <div class="view-order">
                    <table class="table table-striped">
                        <thead>
                            <tr>
                                <th class="col-xs-12 col-sm-4 invoice-col">
                                    {{ __('frontstaticword.From') }}:
                                ...
                                <th class="col-xs-12 col-sm-4 invoice-col">
                                    ...
                                    <span class="table-status {{($payout->pay_status ==1)? 'status-approved' : 'status-pending'}}">
