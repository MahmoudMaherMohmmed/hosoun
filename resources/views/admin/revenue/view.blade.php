        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <a href="{{route('admin.completed')}}" class="btn btn-success pull-right owtbtn">
                ...
                <div class="panel-body">
                            ...
                            <div class="row invoice-info">
                                <div class="col-xs-12 col-sm-4 invoice-col">
                                    ...
                                    <address>
                                        ...
                                        {{ __('adminstaticword.Address') }}: {{ $payout->payer['address'] }}<br>
                    ...
                    <div class="print-btn" style="display: inline-block;">
                        <a href="{{route('payout.download',$payout->id)}}" target="_blank"
                            class="btn btn-info">{{ __('frontstaticword.Download') }}</a>
                    </div>
