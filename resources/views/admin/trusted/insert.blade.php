...
@section('title', __('adminstaticword.Add') . ' ' . __('adminstaticword.TrustedSlider') . ' - ' . __('adminstaticword.Admin'))
@section('body')
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <form id="demo-form2" method="post" action="{{url('trusted/')}}" data-parsley-validate enctype="multipart/form-data">
                        {{ csrf_field() }}

                        <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group">
                                    <label for="url">{{ __('adminstaticword.URL') }}:<sup class="redstar">*</sup></label>
                                    <input id="url" class="form-control" required type="text" name="url" placeholder="Please Enter Your trusted Url">
                                </div>
                            </div>
                        </div>
