...
@section('title', __('adminstaticword.TrustedSlider') . ' - ' . __('adminstaticword.Admin'))
@section('body')
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="table-edit" href="{{url('trusted/'.$trusted->id)}}">
                                            <i class='bx bx-edit'></i></a>
                                    </td>
                                    <td>
                                        <form method="post" action="{{url('trusted/'.$trusted->id)}}" data-parsley-validate>
                                            {{ csrf_field() }}
                                            {{ method_field('DELETE') }}
