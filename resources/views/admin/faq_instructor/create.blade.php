    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <form id="demo-form2" method="post" action="{{url('faqinstructor/')}}" data-parsley-validate
                        ...
                        <div class="box-footer">
                            <div class="row">
                                ...
                                <button type="submit"
                                    class="btn btn-lg col-xs-4 col-md-3 btn-primary">{{ __('adminstaticword.Submit') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
