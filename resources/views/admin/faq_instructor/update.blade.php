        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"> {{ __('adminstaticword.Edit') }} {{ __('adminstaticword.FAQ') }} - {!!
                        $find->title !!} </h3>
                    <a href="{{url('faqinstructor')}}" class="btn btn-success pull-right owtbtn">
                        {{ __('adminstaticword.Back') }}
                    </a>
                </div>
                <form id="demo-form2" method="post" action="{{url('faqinstructor/'.$find->id)}}" data-parsley-validate
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group">
                                    <label for="exampleInputTitle">{{ __('adminstaticword.Title') }}:<sup
                            ...
                            <div class="col-xs-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="detail" class="form-control"
                                        name="details"> {{$find->details}}</textarea>
                                </div>
                            </div>
                            <div class="col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="toggler">
                                        ...
                                        <label class="main-toggle toggle-lg {{ $find->status == '1' ? 'on' : '' }}"
                                            for="status">
                        ...
                        <div class="box-footer">
                            <div class="row">
                                ...
                                <button type="submit"
                                    class="btn btn-lg col-xs-4 col-md-3 btn-primary">{{ __('adminstaticword.Save') }}</button>
                            </div>
                        </div>
                    </div>
                    <!-- /.box -->
