...
@section('title', __('adminstaticword.new_jitsi') . ' - ' . __('adminstaticword.Admin'))
@section('body')
                    ...
                    <form autocomplete="off" action="{{ route('jitsi.meeting.save') }}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <div class="toggler">
                                ...
                                <label class="main-toggle" for="link_by">
                        ...
                        <div class="form-group">
                            <label>
                                {{ __('adminstaticword.MeetingAgenda') }}:<sup class="redstar">*</sup>
                            </label>
