...
@section('title', __('adminstaticword.Edit') . ' ' . __('adminstaticword.BundleCourse') . ' - ' . __('adminstaticword.Admin'))
@section('body')
        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    <h3 class="box-title"> {{ __('adminstaticword.Edit') }} {{ __('adminstaticword.BundleCourse') }}</h3>
                    <a href="{{url('bundle')}}" class="btn btn-success pull-right owtbtn">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12">
                                <div class="form-group">
                                    ...
                                    <select id="course_id" class="form-control js-example-basic-single"
                                        name="course_id[]" multiple="multiple" size="5" row="5"
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="toggler">
                                        <input hidden id="cb111" name="type" type="checkbox"
                                            {{ $cor->type == '1' ? 'checked' : '' }} />
                                        <label class="main-toggle toggle-lg {{ $cor->type == '1' ? 'on' : '' }}"
                                            for="cb111">
                                            <span data-off="{{ __('adminstaticword.Free') }}"
                                                data-on="{{ __('adminstaticword.Paid') }}"></span>
                                        </label>
                                        </li>
                                        <input type="hidden" name="free" value="0" id="j111">
                                    </div>

                                    <div @if ($cor->price == '' && $cor->price == '') class="display-none" @endif
                                        id="doabox">
                                        <div class="form-group">
                                    ...
                                    <div @if ($cor->price == '' && $cor->discount_price == '') class="display-none"
                                        @endif id="doaboxx">
                                        <div class="form-group">
                                            <label for="discount_price">{{ __('adminstaticword.DiscountPrice') }}:
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <div class="toggler">
                                            ...
                                            <label
                                                class="main-toggle toggle-lg {{ $cor->is_subscription_enabled ? 'on' : '' }}"
                                                for="cbToggleSubscription">
                                                <span data-off="{{ __('adminstaticword.Disable') }}"
                                                    data-on="{{ __('adminstaticword.Enable') }}"></span>
                                            </label>
                                        </div>
                                        <small class="text-muted"><i class="fa fa-question-circle"></i> Subscription
                                            bundle works with stripe payment only.</small>
                                        <br>
                                        <small class="text-muted"> Enable it only when you have setup
                                            stripe.</small>
                                        <input name="is_subscription_enabled" type="hidden"
                                            value="{{ $cor->is_subscription_enabled }}"
                                            id="is_subscription_enabled" />
                                    </div>

                                    <div id="stripeSubscriptionContainer"
                                        ...
                                        <div class="form-group">
                                            ...
                                            @endphp
                                            <label
                                                for="billing_interval">{{ __('adminstaticword.BillingPeriod') }}</label>
                                            <select id="billing_interval" class="form-control"
                                                name="billing_interval">
                                                <option value="day"
                                                    {{ $selectedPeriod == 'day' ? 'selected' : '' }}>
                                                    Daily</option>
                                                <option value="week"
                                                    {{ $selectedPeriod == 'week' ? 'selected' : '' }}>
                                                    Weekly</option>
                                                <option value="month"
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <div class="toggler">
                                            ...
                                            <label
                                                class="main-toggle toggle-lg {{ $cor->duration_type == "m" ? 'on' : '' }}"
                                                for="duration_type">
                                                <span data-off="{{ __('adminstaticword.Days') }}"
                                                    data-on="{{ __('adminstaticword.Month') }}"></span>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label
                                            for="duration">{{ __('adminstaticword.BundleExpireDuration') }}</label>
                                        <input min="1" class="form-control" name="duration" type="number"
                                            id="duration" value="{{ $cor->duration }}"
                            ...
                            <div class="col-xs-12 col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="toggler">
                                        <input hidden id="cb333" type="checkbox"
                                            {{ $cor->status == 1 ? 'checked' : '' }}>
                                        <label class="main-toggle toggle-lg {{ $cor->status == 1 ? 'on' : '' }}"
                                            for="cb333">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        ...
                                        <label for="image"><svg xmlns="http://www.w3.org/2000/svg" width="10"
