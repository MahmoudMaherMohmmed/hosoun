...
@section('title', __('adminstaticword.BundleCourse') . ' - ' . __('adminstaticword.Admin'))
@section('body')
        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">{{ __('adminstaticword.BundleCourse') }}</h3>
                    <a class="btn btn-info btn-sm" href="{{url('bundle/create')}}">
                        <i class="glyphicon glyphicon">+</i> {{ __('adminstaticword.Add') }}
                        {{ __('adminstaticword.BundleCourse') }}
                    </a>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <img src="images/bundle/<?php echo $cat['preview_image'];  ?>"
                                    ...
                                    <td>
                                        <a class="table-edi" href="{{ route('bundle.show',$cat->id) }}">
                            ...
                            " data-parsley-validate class="form-horizontal form-label-left">
                                            ...
                                            <button onclick="return confirm('Are you sure you want to delete?')"
                                                type="submit" class="btn-null table-delete"><i
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <img src="images/course/<?php echo $cor['preview_image'];  ?>"
                                            class="img-responsive">
                                        @else
                                    ...
                                    <td>
                                        <form method="post" action="{{url('bundle/'.$cor->id)}}" data-parsley-validate class="form-horizontal form-label-left">
                                            {{ csrf_field() }}
                                            {{ method_field('DELETE') }}
                                            <button onclick="return confirm('Are you sure you want to delete?')"
                                                type="submit" class="btn-null table-delete"><i
