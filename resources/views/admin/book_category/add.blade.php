...
@section('title', __('adminstaticword.AddBookCategory'))
        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">{{ __('adminstaticword.AddBookCategory') }}</h3>
                ...
                <div class="panel-body">
                    ...
                    <form id="demo-form" method="post" action="{{ route('book-categories.store') }}" data-parsley-validate class="form-label-left" autocomplete="off"
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="toggler">
                                        <input hidden id="status" type="checkbox" name="status" {{ isset($cate) && $cate->status == '1' ? 'checked' : '' }}>
                                        <label class="main-toggle toggle-lg {{ isset($cate) && $cate->status == '1' ? 'on' : '' }}" for="status">
