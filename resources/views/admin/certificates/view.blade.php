...
@section('title', __('adminstaticword.Invoice') . ' - ' . __('adminstaticword.Admin'))
@section('body')
        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                ...
                <div class="panel-body">
                            ...
                            <div class="row invoice-info">
                                <div class="col-xs-12 col-sm-4 invoice-col">
                                    ...
                                    <address>
                                        ...
                                        {{ __('adminstaticword.Address') }}: {{ $show->courses->user['address'] }}<br>
                                ...
                                <div class="col-xs-12 col-sm-4 invoice-col">
                                    ...
                                    <b>
                                        ...
                                        {{ __('adminstaticword.EnrollEnd') }}:</b>
                                    {{ date('jS F Y', strtotime($show['enroll_expire'])) }}</br>
                                    @endif
                                    <br>

                                    @if($show->proof != NULL)
                                    <a href="{{ asset('images/order/'.$show->proof) }}" download="{{$show->proof}}"
                                        title="Course">{{ __('adminstaticword.Download') }} Proof <i class="fa fa-download"></i></a></br>
                                    @endif
                                    <br>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                (-)&nbsp;{{ $show['coupon_discount'] }}<i
                                                    class="{{ $show['currency_icon'] }}"></i>
                                                @endif
                                            </td>
                                            @endif
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            ...
                                            <div class="purchase-history-course-title display-inline-flex"
                    ...
                    <input type="button" class="btn btn-primary" onclick="printDiv('printableArea')"
                        value="{{ __('adminstaticword.Print') }} {{ __('adminstaticword.Invoice') }}" />
