...
@section('title', __('adminstaticword.Add') . ' ' . __('adminstaticword.Testimonial') . ' - ' . __('adminstaticword.Admin'))
@section('body')
    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <form id="demo-form2" method="post" action="{{url('testimonial/')}}" data-parsley-validate enctype="multipart/form-data">
                        {{ csrf_field() }}
                            ...
                            <div class="col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="client_name" id="client_name"
                                        placeholder="{{ __('adminstaticword.Enter') }} {{ __('adminstaticword.Name') }}"
                                        value="">
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12">
                                <div class="form-group">
                                    <label for="details">{{ __('adminstaticword.Detail') }}:<sup
                                        class="redstar">*</sup></label>
                                    <textarea id="details" name="details" rows="5" class="form-control" placeholder="{{ __('adminstaticword.Enter') }} {{ __('adminstaticword.Detail') }}">{{ old('details')}}</textarea>
                                </div>
                            </div>
                        </div>
